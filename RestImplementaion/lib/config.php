 ...
 * @Version : 0.0
 * @Description : File contains all necessare  configuration variable used in this package.
**/
	    ...
	    */
	    private function __construct()
	    {
	        ...
	        */
			...
			/*
	        |--------------------------------------------------------------------------
	        | Web service output format
	        |--------------------------------------------------------------------------
	        | Display Web Service Output format. We have 2 available options XML, JSON
	        */
